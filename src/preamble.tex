...
%% FIXME: \setmainfont[Mapping=tex-text,Numabers=OldStyle]{Palatino}
%% FIXME: \setsansfont[Mapping=tex-text,Numbers=OldStyle,Scale=MatchLowercase]{Gill Sans}
%% \setmonofont[Mapping=tex-text,Scale]{Iosevka}
\setmonofont[Contextuals={Alternate},Scale]{Iosevka}
...
\usepackage{noweb}
\noweboptions{smallcode,longxref,longchunks,english,externalindex}
...
\usepackage{hyperref}
\newcommand{\srclink}[1]{%
  \href{https://github.com/yurrriq/aoc18/blob/master/#1}{%
    \mintinline{text}{#1}%
  }%
}
